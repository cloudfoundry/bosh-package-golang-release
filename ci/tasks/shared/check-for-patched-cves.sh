...
echo "!!!!!!!!!!!!!!"
echo "A better maintained generic version of this task is available here: https://github.com/cloudfoundry/bosh-shared-ci/blob/main/tasks/release/check-for-patched-cves.yml"
